...
public class OrderUtil {
    ...
    public OrderUtil getInstance(){
        return new OrderUtil(1023);
    }
     ...
     */
    public OrderUtil(long workerId) {
     ...
     * @return
     */
    public String generaterOrderNo(OrderTypeEnum orderTypeEnum) {
        OrderUtil util = new OrderUtil(1023);
        return orderTypeEnum.getOrderType() + String.valueOf(util.nextId());
    }
}
